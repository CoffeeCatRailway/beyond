...
{
    private static final RenderType PLANET_SHADE = create(Beyond.MOD_ID + ":planet_shade", DefaultVertexFormat.NEW_ENTITY, 7, 256, true, false, RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(SpacePlanetSpriteManager.ATLAS_LOCATION, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setFogState(RenderStateShard.NO_FOG).createCompositeState(true));
    private static final RenderType PLANET = create(Beyond.MOD_ID + ":planet", DefaultVertexFormat.NEW_ENTITY, 7, 256, true, false, RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(SpacePlanetSpriteManager.ATLAS_LOCATION, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(NO_DIFFUSE_LIGHTING).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setFogState(RenderStateShard.NO_FOG).createCompositeState(true));
    private static final RenderType PLANET_ATMOSPHERE_SHADE = create(Beyond.MOD_ID + ":planet_atmosphere_shade", DefaultVertexFormat.NEW_ENTITY, 7, 256, true, true, RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(SpacePlanetSpriteManager.ATLAS_LOCATION, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setFogState(RenderStateShard.NO_FOG).createCompositeState(true));
    private static final RenderType PLANET_ATMOSPHERE = create(Beyond.MOD_ID + ":planet_atmosphere", DefaultVertexFormat.NEW_ENTITY, 7, 256, true, true, RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(SpacePlanetSpriteManager.ATLAS_LOCATION, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(NO_DIFFUSE_LIGHTING).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setFogState(RenderStateShard.NO_FOG).createCompositeState(true));
    private static final RenderType[] PLANETS = {PLANET, PLANET_SHADE, PLANET_ATMOSPHERE, PLANET_ATMOSPHERE_SHADE};
    private static final RenderType PLANET_SELECT = create(Beyond.MOD_ID + ":planet_select", DefaultVertexFormat.NEW_ENTITY, 7, 256, true, true, RenderType.CompositeState.builder().setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(NO_DIFFUSE_LIGHTING).setLightmapState(NO_LIGHTMAP).setOverlayState(NO_OVERLAY).setFogState(RenderStateShard.NO_FOG).createCompositeState(false));
